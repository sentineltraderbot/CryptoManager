...
namespace CryptoManager.Repository.Migrations
{
    ...
    [Migration("20250605172154_AddingTokenSaleTable")]
    partial class AddingTokenSaleTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoManager.Domain.Entities.TokenSale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal>("ReferralQuantity")
                        .HasColumnType("decimal(18, 8)");

                    b.Property<Guid?>("ReferralUserId")
                        .HasColumnType("TEXT");

                    b.Property<string>("ReferralWalletAddress")
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("RegistryDate")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("SENTBOTQuantity")
                        .HasColumnType("decimal(18, 8)");

                    b.Property<decimal>("SOLQuantity")
                        .HasColumnType("decimal(18, 8)");
            ...
            modelBuilder.Entity("CryptoManager.Domain.Entities.TokenSale", b =>
                {
                    ...
                    b.HasOne("CryptoManager.Domain.Entities.ApplicationUser", "ReferralUser")
                        .WithMany()
